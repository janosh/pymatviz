    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(
            ...
            x_range=normalize_plot_json(x_range, "BarPlot.x_range"),
            x2_range=normalize_plot_json(x2_range, "BarPlot.x2_range"),
            y_range=normalize_plot_json(y_range, "BarPlot.y_range"),
