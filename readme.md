...
|               ![phonon-bands-and-dos][phonon-bands-and-dos]                |                                                      |
...
| :-----------------------------------------------------------------------: | :---------------------------------------------------------------: |
| ![sankey-spglib-vs-aflow-spacegroups][sankey-spglib-vs-aflow-spacegroups] | ![sankey-from-2-df-cols-randints][sankey-from-2-df-cols-randints] |
...
![matbench-phonons-structures-2d][matbench-phonons-structures-2d]
...
|          ![scatter-with-err-bar][scatter-with-err-bar]          |            ![residual-vs-actual][residual-vs-actual]            |
...
[heatmap]: https://raw.githubusercontent.com/janosh/pymatviz/main/assets/heatmap-mixing-enthalpy.svg
