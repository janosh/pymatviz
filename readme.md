...
|                           [`structure_3d(hea_structure)`](pymatviz/structure/figures.py#L424)                            | [`structure_3d(lco_supercell)`](pymatviz/structure/figures.py#L424) [![fig-icon]](assets/scripts/structure/structure_3d.py) |
| :----------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------: |
|                                                   ![hea-structure-3d]                                                    |                                                     ![lco-structure-3d]                                                     |
| [`structure_2d(six_structs)`](pymatviz/structure/figures.py#L27) [![fig-icon]](assets/scripts/structure/structure_2d.py) |  [`structure_3d(six_structs)`](pymatviz/structure/figures.py#L424) [![fig-icon]](assets/scripts/structure/structure_3d.py)  |
