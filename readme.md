...
|                 [`phonon_bands_and_dos(bands_dict, doses_dict)`](pymatviz/phonons/figures.py#L594)                  | [`phonon_bands_and_dos(single_bands, single_dos)`](pymatviz/phonons/figures.py#L594) [![fig-icon]](assets/scripts/phonons/phonon_bands_and_dos.py) |
